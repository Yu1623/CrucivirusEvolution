...
def main():
    kmerCPRepVisual("kmerRankCruci.txt")
    kmerCPRepVisual("kmerRankRNA.txt")
    kmerCPRepVisual("kmerRankDNA.txt")
    kmerCPRepCompareVisual("kmerRankCruci.txt", "kmerRankRNA.txt", "kmerRankDNA.txt")
